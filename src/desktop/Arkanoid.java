...
{	
	 ...
	 * 
	 */
	public static Bonus[][] premios= new Bonus[12][12];
	

	/*
	 * Musica de fondo del juego
	 */
	public static Toca cancion1;
	public static Toca cancion2;
	public static Toca cancion3;
	/*
	...
	public Arkanoid(){
		...
		JFrame ventana = new JFrame("Arkanoid | Autores: Gonzalez Ezequiel  &  Lorenzo Martin || Universidad de Belgrano || Ing. Software 2");  //Creamos la ventana
	...
	public void actualizarMundo(){
		 ...
		 */
		for (int i=0;i<12;++i){ //recorremos las filas
			for (int j=0;j<12;++j){//recorremos las columnas
	...
	public void start(){
		...
		cancion1 = new Toca("florida.wav");
		cancion2 = new Toca("cancion2.wav");
		if(Menu.musicaactiva && menu.seleccion==2){
			cancion1.start(); //Aplicamos sonido general
		}
		else if (Menu.musicaactiva && menu.seleccion==3){
			cancion2.start(); //Aplicamos sonido general
		}
