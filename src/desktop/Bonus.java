 ...
 * k: Automaticamente pasa de nivel.
 * i:  Deja a la bola quieta en la barra
 */
public class Bonus extends Actor{
	...
	public void setTipo(char tipo){
		...
		else if(tipo=='k')setNombreSprite("bonus/k.gif");
		...
		else if(tipo=='l')setNombreSprite("bonus/l.gif");
